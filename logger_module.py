...
def update_train_log(country: str, date_range: str, metric: str, runtime: float, 
    ...
    # Define the header
    header = "unique_id,timestamp,date_range,country,metric,model_version,runtime,mode,model_name,scaler_name"
